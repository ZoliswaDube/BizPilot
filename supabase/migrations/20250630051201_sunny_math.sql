/*
  # Add Categories, Suppliers, and Inventory Transactions
  ...
  1. New Tables
    - `categories`
      ...
      - `name` (text)
      - `parent_id` (uuid, self-referencing foreign key for nested categories)
      - `attributes` (jsonb for flexible category attributes)
  ...
  2. Foreign Key Relationships
    ...
    - Link inventory transactions to inventory items
...
-- Add foreign key constraints for the new relationships using DO blocks
DO $$
BEGIN
